...
import { SAVE_FORMULA_BASE } from '../../../services/FormulaBaseService'
import { OBTENER_MATERIAS_PRIMAS } from '../../../services/MateriaPrimaService'
import { Input } from 'rsuite';
const { Column, HeaderCell, Cell, Pagination } = Table;

const NuevaFormulaBase = ({ ...props }) => {
    ...
    const [insertar] = useMutation(SAVE_FORMULA_BASE)
    ...
    const onSaveFormula = async () => {
        try {
            ...
            const { estado, message } = data.insertarFormulaBase;
    ...
    return (
        <div>
            ...
            <Table className="shadow-lg" height={200} autoHeight data={formula}>
                <Column flexGrow={1}>
...
export default withRouter(NuevaFormulaBase);